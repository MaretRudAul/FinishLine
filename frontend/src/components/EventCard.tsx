...
const EventCard: React.FC<EventCardData> = ({
  ...
  return (
    ...
    bg-darkred wrap:wrap ">
      <div>

        {/* Title */}
        <div className="mb-2"> <h2 className="text-2xl font-bold text-white text-center ml-4 mr-4 font-sans italic tracking-wide">{title}</h2>
        </div>
        ...
        {/* Description */}
        <div className="mb-2">
          <p className="text-white ml-4 mr-4">{description}</p>
        </div>
        ...
        {/* Date and Time */}
        <div className="mb-2">
          <p className="text-gray-200 ml-4 mr-4 sm:text-sm">
